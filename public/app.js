...
function conversationIcon(type) {
  return ({
    public_channel: "#",
    private_channel: '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect x="5" y="10" width="14" height="10" rx="2"/><path d="M8 10V7a4 4 0 0 1 8 0v3"/></svg>',
    im: '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="8" r="3"/><path d="M5 20c.7-3.4 3-5 7-5s6.3 1.6 7 5"/></svg>',
    mpim: '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="9" cy="8" r="3"/><circle cx="17" cy="10" r="2"/><path d="M3 20c.6-3.4 2.6-5 6-5s5.4 1.6 6 5M15 16c3 0 4.7 1.3 5 4"/></svg>',
    unknown: "?",
  })[type] ?? "?";
}
...
function renderSettings(settings) {
  ...
  const filterField = settingsForm.elements.namedItem("conversationNameFilterTerms");
  if (document.activeElement !== filterField) filterField.value = settings.conversationNameFilterTerms ?? "";
